...
.progressbar {
	...
	border-radius: 16px;
	margin: 40px auto;
	-webkit-box-shadow: 0px 4px 4px -4px rgba(255, 255, 255, 0.4), 0px -3px
		3px -3px rgba(255, 255, 255, 0.25), inset 0px 0px 12px 0px
		rgba(0, 0, 0, 0.5);
	box-shadow: 0px 4px 4px -4px rgba(255, 255, 255, 0.4), 0px -3px 3px -3px
		rgba(255, 255, 255, 0.25), inset 0px 0px 12px 0px rgba(0, 0, 0, 0.5);
}
...
.bar {
	...
	background: -moz-linear-gradient(top, rgba(164, 217, 233, 1) 0%,
		rgba(91, 186, 215, 1) 100%);
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(164,
		217, 233, 1)), color-stop(100%, rgba(91, 186, 215, 1)));
	background: -webkit-linear-gradient(top, rgba(164, 217, 233, 1) 0%,
		rgba(91, 186, 215, 1) 100%);
	background: -o-linear-gradient(top, rgba(164, 217, 233, 1) 0%,
		rgba(91, 186, 215, 1) 100%);
	background: -ms-linear-gradient(top, rgba(164, 217, 233, 1) 0%,
		rgba(91, 186, 215, 1) 100%);
	background: linear-gradient(to bottom, rgba(164, 217, 233, 1) 0%,
		rgba(91, 186, 215, 1) 100%);
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#a4d9e9',
		endColorstr='#5bbad7', GradientType=0);
	-webkit-border-radius: 16px;
	border-radius: 16px;
	-webkit-box-shadow: 0px 0px 12px 0px rgba(40, 133, 164, 1), inset 0px
		1px 0px 0px rgba(255, 255, 255, 0.45), inset 1px 0px 0px 0px
		rgba(255, 255, 255, 0.25), inset -1px 0px 0px 0px
		rgba(255, 255, 255, 0.25);
	box-shadow: 0px 0px 12px 0px rgba(40, 133, 164, 1), inset 0px 1px 0px
		0px rgba(255, 255, 255, 0.45), inset 1px 0px 0px 0px
		rgba(255, 255, 255, 0.25), inset -1px 0px 0px 0px
		rgba(255, 255, 255, 0.25);
	overflow: hidden;
}
...
.bar:before {
	...
	top: -25%;
	left: -25px;
	background: -moz-radial-gradient(center, ellipse cover, rgba(255, 255, 255, 0.35)
		0%, rgba(255, 255, 255, 0.01) 50%, rgba(255, 255, 255, 0) 51%,
	...
	background: -webkit-radial-gradient(center, ellipse cover, rgba(255, 255, 255, 0.35)
		0%, rgba(255, 255, 255, 0.01) 50%, rgba(255, 255, 255, 0) 51%,
		rgba(255, 255, 255, 0) 100%);
	background: -o-radial-gradient(center, ellipse cover, rgba(255, 255, 255, 0.35)
		0%, rgba(255, 255, 255, 0.01) 50%, rgba(255, 255, 255, 0) 51%,
		rgba(255, 255, 255, 0) 100%);
	background: -ms-radial-gradient(center, ellipse cover, rgba(255, 255, 255, 0.35)
		0%, rgba(255, 255, 255, 0.01) 50%, rgba(255, 255, 255, 0) 51%,
		rgba(255, 255, 255, 0) 100%);
	background: radial-gradient(ellipse at center, rgba(255, 255, 255, 0.35)
		0%, rgba(255, 255, 255, 0.01) 50%, rgba(255, 255, 255, 0) 51%,
		rgba(255, 255, 255, 0) 100%);
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#59ffffff',
...
.bar:after {
	...
	background: -moz-linear-gradient(left, rgba(255, 255, 255, 0) 0%,
		rgba(255, 255, 255, 0.6) 98%, rgba(255, 255, 255, 0) 100%);
	background: -webkit-gradient(linear, left top, right top, color-stop(0%, rgba(255,
		255, 255, 0)), color-stop(98%, rgba(255, 255, 255, 0.6)),
		color-stop(100%, rgba(255, 255, 255, 0)));
...
.label {
	...
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(76,
		76, 76, 1)), color-stop(100%, rgba(38, 38, 38, 1)));
...
.label span:before {
	...
	background: -moz-linear-gradient(-45deg, rgba(86, 86, 86, 1) 0%,
		rgba(76, 76, 76, 1) 50%);
	background: -webkit-gradient(linear, left top, right bottom, color-stop(0%, rgba(86,
		86, 86, 1)), color-stop(50%, rgba(76, 76, 76, 1)));
	background: -webkit-linear-gradient(-45deg, rgba(86, 86, 86, 1) 0%,
		rgba(76, 76, 76, 1) 50%);
	background: -o-linear-gradient(-45deg, rgba(86, 86, 86, 1) 0%,
		rgba(76, 76, 76, 1) 50%);
	background: -ms-linear-gradient(-45deg, rgba(86, 86, 86, 1) 0%,
		rgba(76, 76, 76, 1) 50%);
	background: linear-gradient(135deg, rgba(86, 86, 86, 1) 0%,
		rgba(76, 76, 76, 1) 50%);
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#565656',
		endColorstr='#4c4c4c', GradientType=1);
...
<body>
				...
				<div class="col-md-3">
					<fieldset>
						...
						<table>
							...
							<tr>
								<td><button
										onclick="lacation.href='localhost:8000/dalhada/Editinfo'">회원정보
										수정</button></td>
							</tr>
							<tr>
								<td>
						...
						<table>
							<tr>
								<td><div class="progressbar"
										data-perc='<c:if test="${!empty perc}">${perc}</c:if><c:if test="${empty perc}">0</c:if>'>
										<div class="bar">
											<span></span>
										</div>
										<div class="label">
	...
	<script type="text/javascript">
							...
							function() {
								...
								function perc() {
									var length = t.find('.bar').css('width'), perc = Math
											.round(parseInt(length) / 5.56), labelpos = (parseInt(length) - 2);
		...
		function changeFunc() {
			...
			location.href = 'http://localhost:8000/dalhada/Mypage?group='
					+ selectedValue;
			alert('hi');
		}
	</script>
